...
import in.risysnetworks.shplayer.observablelib.ObservableScrollView;
import in.risysnetworks.shplayer.observablelib.ObservableScrollViewCallbacks;
import in.risysnetworks.shplayer.observablelib.ScrollState;
import in.risysnetworks.shplayer.observablelib.ScrollUtils;
...
import in.risysnetworks.shplayer.utils.ExpandableHeightListView;
...
public class AlbumAndArtisDetailsActivity extends ActionBarActivity implements View.OnClickListener, ObservableScrollViewCallbacks, Slider.OnValueChangedListener,
    ...
    public void onBackPressed() {
        if (isExpand) {
            ...
            sharedPreferences.edit().putInt("Back", 2).apply();
    ...
    public class AllSongsListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = layoutInflater.inflate(R.layout.item_allsongs, null);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mDetail != null) {
                        ...
                        System.out.println(" is playing --> " + MediaController.getInstance().isPlayingAudio(mDetail)
...
//            }
            ...
            mViewHolder.imagemore.setVisibility(View.GONE);
