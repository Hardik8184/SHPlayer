package in.risysnetworks.shplayer.databasemanager;
...
public class MostAndRecentPlayTableHelper {
    ...
    private static SHPLayerDBHelper dbHelper = null;
    ...
    public MostAndRecentPlayTableHelper(Context context_) {
        ...
        if (dbHelper == null) {
            dbHelper = ((ApplicationSHPlayer) context.getApplicationContext()).DB_HELPER;
        }
    }
