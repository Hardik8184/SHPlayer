...
public class FragmentMostPlay extends Fragment {
    ...
    public static FragmentMostPlay newInstance(int position, Context mContext) {
        FragmentMostPlay f = new FragmentMostPlay();
        context = mContext;
        return f;
    }
